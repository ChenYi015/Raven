...
if __name__ == '__main__':
    ...
    start = datetime.strptime('2021-11-27 05:44:53', '%Y-%m-%d %H:%M:%S')
    ...
    metric = aws.get_ec2_metrics(master_dict, start, end)
    ...
    for core_dict in core_dicts:
        metric = aws.get_ec2_metrics(core_dict, start, end)
    ...
    # start = datetime.strptime('2021-11-28 02:15:39', '%Y-%m-%d %H:%M:%S')
