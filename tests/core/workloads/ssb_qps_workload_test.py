...
from benchmark.workloads.ssb import SsbLoopWorkload, SsbQpsWorkload
...
if __name__ == '__main__':
    ssb_loop_workload = SsbQpsWorkload()
    queue = Queue()

    generate_thread = Thread(
        target=ssb_loop_workload.generate_queries_with_distribution,
        args=(queue,),
        kwargs={
